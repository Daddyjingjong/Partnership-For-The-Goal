...
import kotlinx.android.synthetic.main.activity_share_ideas.*


class ShareIdeas : AppCompatActivity() {
    internal var dbHelper = DatabaseHelper(this)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_share_ideas)
...
//                db.execSQL("INSERT INTO users VALUES ('"+name+"','"+profession+"','"+residence+"','"+password+"')")
                ...
                show_message("Success", " Ideas saved successfully")
                clear()
